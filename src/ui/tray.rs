...
pub fn start_tray(
    ...
    let service = ImeTray { chinese_enabled, active_profile, show_candidates, show_notifications, anti_typo, commit_mode, preview_mode, candidate_layout, tx: event_tx };
